      ...
      <div className="w-full max-w-md p-8 bg-white shadow-md rounded-lg">
        {
          loggedUser ? (
            <div className="text-center">
              <h2 className="text-2xl font-semibold">Vítejte, {loggedUser.name}!</h2>
              <p className="mt-4">Jste přihlášeni a můžete začít procvičovat svoje jazykové dovednosti. Vyberte si z různých typů cvičení pro posílení vaší angličtiny.</p>
              <div className="mt-6">
                <Link 
                  to="/exercise"
            ...
            <div className="text-center">
              <h1 className="text-3xl font-bold">Vítejte v aplikaci English Trainer!</h1>
              <p className="mt-4 mb-8">Tato aplikace je vaším pomocníkem pro procvičování a rozšíření slovní zásoby v anglickém jazyce. Pro využití plného potenciálu aplikace se prosím přihlašte nebo vytvořte nový účet.</p>
