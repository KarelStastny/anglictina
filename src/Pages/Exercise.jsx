...
const Exercise = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
            {!typeExercise && ( // Zobrazí se pouze pokud typeExercise je prázdný řetězec
                <>
                    <div className="text-center mb-6">
                        <h1 className="text-3xl font-bold">Vyberte typ cvičení</h1>
                        <p className="mt-2">Zvolte si směr překladu a začněte s procvičováním vaší angličtiny nebo češtiny.</p>
                    </div>
            ...
            {typeExercise && <SummaryProgress />}  {/* Přidáno pro zobrazení pokroku */}
        </div>
    );
}
